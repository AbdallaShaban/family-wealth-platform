...
### 6. إجراءات التعافي من الكوارث والنسخ الاحتياطي (Disaster Recovery)

يوفر النظام خدمة النسخ الاحتياطي الشامل `backupRestoreService` التي تشمل كافة الجداول المملوكة للمساحة (51 جدولاً من أصل 56 جدولاً، مع استثناء الجداول المركزية للنظام).

#### تصدير نسخة احتياطية لمساحة عمل:
...
#### استعادة نسخة احتياطية (Restore / Clone):
