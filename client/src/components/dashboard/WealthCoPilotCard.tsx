        ...
        <div className="relative z-10 mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <Badge
                className={
                  emergencyCoverageMonths >= 3
                    ? "bg-emerald-100 text-emerald-950 border border-emerald-300 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800 text-[10px] font-bold"
                    : "bg-amber-100 text-amber-950 border border-amber-300 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-800 text-[10px] font-bold"
                }
              >
                ...
                className={
                  hasActiveDebt
                    ? highestPriorityDebt.interestRate > 0
                      ? "bg-amber-100 text-amber-950 border border-amber-300 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-800 text-[10px] font-bold"
                      : "bg-rose-100 text-rose-950 border border-rose-300 dark:bg-rose-950/60 dark:text-rose-300 dark:border-rose-800 text-[10px] font-bold"
                    : "bg-slate-100 text-slate-800 border border-slate-300 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 text-[10px] font-bold"
                }
              >
                {hasActiveDebt
                  ? highestPriorityDebt.interestRate > 0
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-3.5 flex flex-col justify-between hover:border-sky-500/40 transition-colors">
            <div className="flex items-center justify-between gap-2 mb-1.5">
              ...
              <Badge className="bg-sky-100 text-sky-950 border border-sky-300 dark:bg-sky-950/60 dark:text-sky-300 dark:border-sky-800 text-[10px] font-bold">
                ذهب + أسهم نمو
              </Badge>
            </div>
            <div>
