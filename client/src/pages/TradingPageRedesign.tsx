...
import { CircleAlert, Landmark, Loader2, TrendingUp } from "lucide-react";
...
export default function TradingPageRedesign() {
  ...
  return <DashboardLayout><main className="mx-auto max-w-7xl space-y-6" dir="rtl">
    <header className="flex flex-col gap-4 border-b pb-6 lg:flex-row lg:items-end lg:justify-between">
      <div><p className="text-xs font-semibold uppercase tracking-[.15em] text-emerald-700">FAMILY / TRADE REVIEW</p><h1 className="mt-2 text-3xl font-bold">التداول والحيازات</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">تتحقق المنصة من الرصيد أو الكمية قبل النشر. لا تُنشئ إشارات السوق أي صفقة؛ يبقى القرار والمراجعة والتأكيد مسؤولية المستخدم.</p></div>
      <Button variant="outline" onClick={() => setLocation("/research/prices")}>بيانات المراقبة والأسعار</Button>
    </header>
