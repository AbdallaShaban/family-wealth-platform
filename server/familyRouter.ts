...
import {
  familyCertificatesRouter,
  familyCreditCardsRouter,
} from "./routers/family/familyBankingRouter";
import { familyInstrumentsRouter } from "./routers/family/familyInstrumentsRouter";
import {
...
export const familyRouter = router({
  ...
  certificates: familyCertificatesRouter,
  creditCards: familyCreditCardsRouter,
  instruments: familyInstrumentsRouter,
